...
// Blackbox provides an OpenAI-compatible endpoint; prefer it by default.
// You can override via env var BLACKBOX_API_ENDPOINT if needed.
define('BLACKBOX_API_ENDPOINT', getenv('BLACKBOX_API_ENDPOINT') ?: 'https://api.blackbox.ai/v1/chat/completions');

// Blackbox model to use with /v1/chat/completions.
// You can list available models via: GET https://api.blackbox.ai/v1/models
define('BLACKBOX_MODEL', getenv('BLACKBOX_MODEL') ?: 'blackboxai/mistralai/mistral-7b-instruct:free');
